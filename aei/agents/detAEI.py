"""
This is detAEI.py, a class for obtaining various bits for the deterministic
...
class detAEI(object):
    ...
    def __init__(self,
        ...
        self.gamma = gamma  # the agent's discout factor
    ...
    def obtain_Qisa(self, X):
        ...
        nextV = np.einsum(Tss, [1, 3], Vis, [0, 3], [0, 1])
        nextV = nextV.repeat(self.M).reshape(self.N, self.Z, self.M)

        return (1 - self.gamma) * Risa + self.gamma * nextV
